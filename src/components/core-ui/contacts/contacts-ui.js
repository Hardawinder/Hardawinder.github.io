...
const ContactUI = ({ open, success, errMsg, handleClose, classes, handleContactForm, name, setName, form, email, setEmail, message, setMessage }) => {
  ...
  const onSumbitHandler=(e)=>{
    ...
    sendForm('service_2wrzh8b', 'template_dvzu796', form.current, 'kAL-7-LiDYrHNuTRx')
      .then((result) => {
      ...
      result=='OK'&&
      window.alert('Your request has been sumbitted')}
      else{
        window.alert("Please try to enter valid non empty data ")
      }
  }
